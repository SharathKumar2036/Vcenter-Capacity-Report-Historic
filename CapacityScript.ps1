  ...
  $cred=Get-Credential|Export-Clixml -Path "C:\Users\Administrator.DEMO\Desktop\CRED.xml" 
  $credim=Import-Clixml -Path "C:\Users\Administrator.DEMO\Desktop\CRED.xml" 
  $date=Get-Date 
  $filestring=$date.ToString("yyyy_MM_dd_HHmmss") 
  $vcenters=@('192.168.0.31','192.168.0.32') #ServerUid   
      ...
      $Datacenter=Get-Datacenter         
                ...
                {		            
                    ...
                    Write-Host $datapb                                                                                               
                      ...
                      $am|Export-Excel "C:\Users\Administrator.DEMO\Desktop\Capacity_Report$filestring.xlsx"  -Append -WorksheetName "MtDtCntr($vserver)" -AutoSize -AutoFilter                      
                     }  		            		                                    
                foreach($cluster in $clusters)        		                                    
                {                			                                                        
                $ip=$vserver  #servername                    			                                        
                $cpustat= Get-Stat -Entity $cluster -Stat "cpu.usage.average" -Start "05/18/2023, 12:00:00"  -Finish "06/16/2023, 10:00:00"|Select-Object -ExpandProperty Value
                $mem= Get-Stat -Entity $cluster -Stat  "mem.consumed.average" -Start "05/18/2023, 12:00:00" -Finish "06/16/2023, 10:00:00"|Select-Object -ExpandProperty Value                         			                                        
            ...
            } $results|Export-Excel "C:\Users\Administrator.DEMO\Desktop\Capacity_Report$filestring.xlsx"  -Append -WorksheetName "Vc($vserver)" -AutoSize -AutoFilter                                                           
      
      }$dts|Export-Excel "C:\Users\Administrator.DEMO\Desktop\Capacity_Report$filestring.xlsx" -Append -WorksheetName "Ds($vserver)" -AutoSize -AutoFilter                            
